function newmesh = relaxmesh(orig_mesh,template_mesh)

%% relax the mesh so that verticex spacing is approximates that of the template
niter = 10;
% ----------- SVN REVISION INFO ------------------
% $URL: https://saccade.neurosurgery.uiowa.edu/svn/KovachToolbox/devel/SubNuclear/relaxmesh.m $
% $Revision: 401 $
