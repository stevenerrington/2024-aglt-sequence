...
if exist('postop','var') && isa(postop,'volumeview')
...
%  These are extracted from â€œAtlas of the Human Brainâ€ (Mai 2008). The variables, newmeshR and 
