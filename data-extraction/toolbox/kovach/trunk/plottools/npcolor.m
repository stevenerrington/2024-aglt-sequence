function axes_handles = npcolor(tm,frq,X,varargin)
...
for i = 1:n
    ...
    im = pcolor(tm,frq,X(:,:,i));
    
    shading(shadingv)
    set(gca,'yscale',scalev);
...
if theta ~= 0           %rotates subplots around the center
   thrad = pi*theta/180;
% ----------- SVN REVISION INFO ------------------
% $URL: https://saccade.neurosurgery.uiowa.edu/svn/KovachToolbox/trunk/plottools/npcolor.m $
% $Revision: 39 $
