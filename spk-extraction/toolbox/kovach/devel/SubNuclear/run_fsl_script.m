...
% ----------- SVN REVISION INFO ------------------
% $URL: https://saccade.neurosurgery.uiowa.edu/svn/KovachToolbox/devel/SubNuclear/run_fsl_script.m $
% $Revision: 401 $
...
com8 = sprintf('rm %sT1temp* %spostop_aligned.mat',sid,sid);
...
fprintf(fid,'printf ''\\n\\n''\n\n');
% fprintf(fid,com1);
fprintf(fid, '\n\n%s',com1,com2, com3,com4,com5,com6,com7,com8);
% fprintf(fid,com2);
...
system(sprintf('xterm -e ./%s',scrfname) )
