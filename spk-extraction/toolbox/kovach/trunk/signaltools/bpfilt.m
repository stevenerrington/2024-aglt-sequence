...
% ----------- SVN REVISION INFO ------------------
% $URL: https://saccade.neurosurgery.uiowa.edu/svn/KovachToolbox/trunk/signaltools/bpfilt.m $
% $Revision: 483 $
% $Date: 2014-03-01 23:59:09 -0600 (Sat, 01 Mar 2014) $
% $Author: ckovach $
% ------------------------------------------------
...
% figure;freqz(B,1,1024,filt(1));xlim([0 200]);
