...
%% ----------- SVN REVISION INFO ------------------
% $URL: https://saccade.neurosurgery.uiowa.edu/svn/KovachToolbox/trunk/SubNuclear/do_registration_instructions.m $
% $Revision: 656 $
% $Date: 2015-11-13 11:16:01 -0600 (Fri, 13 Nov 2015) $
% $Author: ckovach $
% ------------------------------------------------