...
classdef IZ2_controller < handle
...
%         mode = 'ppt';
    ...
    methods
        ...
        function me = IZ2_controller(varargin)            
...
%             if code > 128
%                 error('Trigger code must be less than 128');
%             end
%             ppwrite =me.codeoffset*me.do_stimulate_val + code;
             ppwrite = me.trigger_code*me.do_stimulate_val + me.no_stim_code*(1-me.do_stimulate_val);
            if me.isprimed
                me.pport.put(ppwrite);
%                 me.isprimed=0;
                pause(me.TTL_pulsewidth )
                me.pport.put(0);
                pause(me.TTL_pulsewidth )
        ...
        function varargout =putcode(me,code)
            ...
            %%% (verifies that the code is less than 128)
